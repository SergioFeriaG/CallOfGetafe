...
public class VisionDetector : MonoBehaviour
{
    ...
    {
        Vector3 targetDirection = (playerPosition - visionOrigin.position).normalized;//DirecciÛn del rayo
        Ray ray = new Ray(visionOrigin.position, targetDirection);//Rayo
        RaycastHit hitInfo;//Objeto que recoje los datos de la detecciÛn
